 // DOM元素
            ...
            function toggleTheme() {
                ...
                codeBlock.classList.toggle('bg-gray-900');
                codeBlock.classList.toggle('text-gray-200');

                const charPreviews = document.querySelectorAll('#char-preview-container span');
                charPreviews.forEach(span => {
                    span.classList.toggle('bg-gray-700');
                    span.classList.toggle('text-gray-200');
                });

                const fontPreviewEl = document.getElementById('font-preview');
                fontPreviewEl.classList.toggle('bg-gray-900');
